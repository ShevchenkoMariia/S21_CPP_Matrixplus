...
- создание статической библиотеки для работы с матрицами на языке C++;
- разработка и оптимизация алгоритмов для выполнения операций над матрицами (сложение, умножение, транспонирование и т.д.);
- применение принципов ООП, таких как инкапсуляция и перегрузка операторов, для реализации функциональности работы с матрицами;
- подготовка и написание модульных тестов с использованием библиотеки GTest;
- оформление проекта как статической библиотеки с соответствующим заголовочным файлом и настройкой Makefile для сборки;
- соблюдение стиля кодирования Google Style для лучшей читаемости и удобства поддержки кода;
- использование Git.
...
В данном проекте тебе предстоит снова реализовать уже знакомую тебе по проекту __s21_matrix__ библиотеку для работы с матрицами, но на этот раз используя объектно-ориентированный подход (см. материалы). Объектно-ориентированный подход позволяет реализовать библиотеку для работы с матрицами в виде отдельного класса, над объектами которого определены операции, представленные как методами, так и стандартными операторами +, -, * и т. д.
